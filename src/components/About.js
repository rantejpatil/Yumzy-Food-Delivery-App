    ...
    return (
        <div className="flex flex-col justify-center items-center my-5 p-5">
            ...
            {/* <UserClass name={"Nirali Mamaniya (class)"}/> */}
                    <h1 className="text-4xl font-bold font-sans ">Welcome to Yumzy</h1>
                    ...
                    <h1 className="text-lg font-sans font-semibold mt-5">Designed and developed by Rantej Patil</h1>
                    <ul className="flex items-center p-4">
                    <Link to="https://www.linkedin.com/in/rantej-patil-786b64271/">
                        <li className="px-3">
                    ...
                    <Link to="https://github.com/rantejpatil">
                        <li className="px-3">
